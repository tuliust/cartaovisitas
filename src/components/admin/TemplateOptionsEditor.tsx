...
export function TemplateOptionsEditor({ activeVariant, values, uploading, onActiveVariantChange, onAssetChange, onUpload, onVariantChange }: TemplateOptionsEditorProps) {
  ...
  return <section className="brand-settings-section template-options-editor">
    ...
    <p className="template-fallback-note">Escopo fixo: tipografia, QR Code, cores semânticas de sucesso/alerta/erro e a assinatura de e-mail não mudam entre os seis modos. A assinatura mantém Arial e cores próprias para compatibilidade com Gmail e outros clientes.</p>
  </section>
}
