...
export type EmailSignatureContact = { kind: 'phone' | 'email' | 'website'; text: string; href: string; iconUrl: string; alt: string }
...
function contactHtml(contact: EmailSignatureContact) {
  return `<tr><td style="width:22px;padding:2px 7px 2px 0;vertical-align:middle"><a href="${escapeAttribute(contact.href)}" style="text-decoration:none"><img src="${escapeAttribute(contact.iconUrl)}" alt="${escapeAttribute(contact.alt)}" width="15" height="15" style="display:block;width:15px;height:15px;border:0"></a></td><td style="padding:2px 0;vertical-align:middle;font:12px/1.45 Arial,Helvetica,sans-serif;color:#444444"><a href="${escapeAttribute(contact.href)}" style="color:#444444;text-decoration:none">${escapeHtml(contact.text)}</a></td></tr>`
}
