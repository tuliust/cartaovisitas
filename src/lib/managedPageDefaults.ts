  ...
  usage_guide: {
    ...
    content: {
      sections: [
        ...
        { id: "visual", title: "Escolher visual", body: "O sistema oferece seis variantes institucionais: três escuras e três claras. O seletor visual do header altera a preferência da interface e a mantém no navegador por localStorage.\n\nNo formulário de edição, a escolha da variante do cartão é uma configuração própria e precisa ser salva. A preferência global de navegação não altera silenciosamente o visual registrado no cartão." },
