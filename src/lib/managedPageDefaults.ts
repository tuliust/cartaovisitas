...
export const managedPageDefaults: Record<ManagedPageKey, ManagedPage> = {
  terms_and_privacy: { id: null, page_key: 'terms_and_privacy', route_path: '/termos-de-uso-e-privacidade', title: 'Termos de Uso e Privacidade', subtitle: 'Minuta informativa da plataforma de cartões digitais.', visibility: 'public', is_published: true, version_label: 'Versão preliminar 0.1 — 12 de julho de 2026. Pendente de aprovação institucional e jurídica.', updated_by: null, created_at: null, updated_at: null, content: { notice: { title: 'Minuta em revisão', body: `Este documento é uma versão inicial e não deve ser interpretado como parecer jurídico definitivo. ${pending}` }, sections: [
  ...
  usage_guide: { id: null, page_key: 'usage_guide', route_path: '/meu-cartao/guia', title: 'Guia de Utilização', subtitle: 'Aprenda a configurar, divulgar e acompanhar seu cartão digital.', visibility: 'authenticated', is_published: true, version_label: '', updated_by: null, created_at: null, updated_at: null, content: { sections: [
    ...
    { id: 'compartilhar', title: 'Compartilhar vCard', body: 'Em Minha Página, escolha “Compartilhar meu cartão”. Em navegadores compatíveis, o arquivo vCard será encaminhado pelo compartilhamento nativo; nos demais, será baixado.' },
